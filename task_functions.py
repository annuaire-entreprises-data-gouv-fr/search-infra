        ...
        """SELECT
            ...
            (SELECT json_group_array(
                    ...
                    (
                        ...
                        (SELECT liste_finess FROM rge WHERE siret = s.siret) as 
                        liste_finess,
                        (SELECT liste_idcc FROM rge WHERE siret = s.siret) as 
                        liste_idcc,
                        (SELECT liste_rge FROM rge WHERE siret = s.siret) as liste_rge,
                        (SELECT liste_uai FROM rge WHERE siret = s.siret) as liste_uai,
