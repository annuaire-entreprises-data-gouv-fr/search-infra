...
from dag_datalake_sirene.task_functions.upload_db import (
    get_latest_database,
)
...
with DAG(
    dag_id=AIRFLOW_DAG_INDEXING_NAME,
    ...
    clean_previous_folder = CleanFolderOperator(
        ...
        folder_path=f"{AIRFLOW_DAG_TMP}+{AIRFLOW_DAG_FOLDER}+{AIRFLOW_DAG_INDEXING_NAME}",
    )
