...
AIRFLOW_DAG_PREPROCESSING_NAME = "preprocess-database"
...
AIRFLOW_PREPROCESSING_DATA_DIR = (
    AIRFLOW_DAG_TMP + AIRFLOW_DAG_FOLDER + AIRFLOW_DAG_PREPROCESSING_NAME + "/data/"
)
AIRFLOW_INDEXING_DATA_DIR = (
    AIRFLOW_DAG_TMP + AIRFLOW_DAG_FOLDER + AIRFLOW_DAG_INDEXING_NAME + "/data/"
)
SIRENE_DATABASE_LOCATION = AIRFLOW_PREPROCESSING_DATA_DIR + "sirene.db"
SIRENE_MINIO_DATA_PATH = "sirene/database/"
DIRIG_DATABASE_LOCATION = AIRFLOW_PREPROCESSING_DATA_DIR + "rne.db"
