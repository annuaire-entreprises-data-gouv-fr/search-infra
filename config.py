...
EXPORT_DATA_DIR = (
    AIRFLOW_DAG_TMP + AIRFLOW_DAG_FOLDER + AIRFLOW_EXPORT_DAG_NAME + "/data/"
)
...
RNE_DEFAULT_START_DATE = "2026-03-04"
...
# Notification
TCHAP_ENDPOINT = Variable.get("TCHAP_ENDPOINT", "")
TCHAP_OPI_DATA_TOKEN = Variable.get("TCHAP_OPI_DATA_TOKEN", "")
TCHAP_BOT_DEPLOIEMENT_ROOM_ID = Variable.get("TCHAP_BOT_DEPLOIEMENT_ROOM_ID", "")
...
ELASTIC_INDEX_POOL_PROCESSES = Variable.get("ELASTIC_INDEX_POOL_PROCESSES", 12)
