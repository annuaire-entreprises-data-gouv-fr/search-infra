...
STOCK_SIRENE_CONFIG = DataSourceConfig(
    ...
    files_to_download={
        "stock_unite_legale": {
            ...
            "destination": f"{DataSourceConfig.base_tmp_folder}/sirene/stock/StockUniteLegale_{CURRENT_MONTH_STR}.zip",
        },
        "historique_unite_legale": {
            ...
            "destination": f"{DataSourceConfig.base_tmp_folder}/sirene/stock/StockUniteLegaleHistorique_{CURRENT_MONTH_STR}.zip",
        },
        "historique_etablissement": {
            ...
            "destination": f"{DataSourceConfig.base_tmp_folder}/sirene/stock/StockEtablissementHistorique_{CURRENT_MONTH_STR}.zip",
        },
    },
