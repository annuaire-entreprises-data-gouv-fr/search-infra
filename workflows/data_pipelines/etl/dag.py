...
def database_constructor():
    ...
    processor_list = [
        ...
        DatabaseTableConstructor(BILANS_FINANCIERS_CONFIG),
        DatabaseTableConstructor(COLTER_CONFIG),
        DatabaseTableConstructor(ELUS_CONFIG),
        DatabaseTableConstructor(ESS_CONFIG),
        DatabaseTableConstructor(RGE_CONFIG),
        DatabaseTableConstructor(FINESS_CONFIG),
        DatabaseTableConstructor(EGAPRO_CONFIG),
        DatabaseTableConstructor(FORMATION_CONFIG),
        DatabaseTableConstructor(SPECTACLE_CONFIG),
        DatabaseTableConstructor(UAI_CONFIG),
        DatabaseTableConstructor(CONVENTION_COLLECTIVE_CONFIG),
        DatabaseTableConstructor(MARCHE_INCLUSION_CONFIG),
    ]
    tasks = []
