...
from dag_datalake_sirene.workflows.data_pipelines.spectacle.task_functions import (
...
with DAG(
    dag_id="data_processing_entrepreneur_spectacle",
    ...
    clean_previous_outputs = BashOperator(
        ...
        bash_command=(
            f"rm -rf {SPECTACLE_TMP_FOLDER} && mkdir -p {SPECTACLE_TMP_FOLDER}"
        ),
    )
    ...
    preprocess_spectacle_data.set_upstream(clean_previous_outputs)
    save_date_last_modified.set_upstream(preprocess_spectacle_data)
