...
from dag_datalake_sirene.config import (
    COLTER_TMP_FOLDER,
    URL_COLTER_REGIONS,
    RESSOURCE_ID_COLTER_REGIONS,
    URL_COLTER_DEP,
    RESSOURCE_ID_COLTER_DEP,
    URL_COLTER_COMMUNES,
    RESSOURCE_ID_COLTER_COMMUNES,
    URL_ELUS_EPCI,
    RESSOURCE_ID_ELUS_EPCI,
    URL_CONSEILLERS_REGIONAUX,
    RESSOURCE_ID_CONSEILLERS_REGIONAUX,
    URL_CONSEILLERS_DEPARTEMENTAUX,
    RESSOURCE_ID_CONSEILLERS_DEPARTEMENTAUX,
    URL_CONSEILLERS_MUNICIPAUX,
    RESSOURCE_ID_CONSEILLERS_MUNICIPAUX,
    URL_ASSEMBLEE_COL_STATUT_PARTICULIER,
    RESSOURCE_ID_ASSEMBLEE_COL_STATUT_PARTICULIER,
)
