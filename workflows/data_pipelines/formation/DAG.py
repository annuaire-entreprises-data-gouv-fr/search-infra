...
from dag_datalake_sirene.workflows.data_pipelines.formation.task_functions import (
...
with DAG(
    ...
    save_date_last_modified.set_upstream(preprocess_organisme_formation_data)
