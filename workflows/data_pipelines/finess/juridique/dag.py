...
from dag_datalake_sirene.workflows.data_pipelines.finess.juridique.processor import (
...
def data_processing_finess_juridique():
    ...
    def send_file_to_minio():
        return finess_juridique_processor.send_file_to_minio()

    @task
    def compare_files_minio():
        return finess_juridique_processor.compare_files_minio()
