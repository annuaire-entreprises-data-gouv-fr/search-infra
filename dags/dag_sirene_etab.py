...
from workflows.data_pipelines.sirene.etab.task_functions import (
...
with DAG(
    ...
    clean_previous_outputs = BashOperator(
        ...
        bash_command=(
            f"rm -rf {Settings.INSEE_TMP_FOLDER}etab/ && mkdir -p {Settings.INSEE_TMP_FOLDER}etab/"
        ),
    )
    ...
    download_stock_etab.set_upstream(send_historique_file_to_minio)
