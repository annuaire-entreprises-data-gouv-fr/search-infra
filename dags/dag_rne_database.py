...
from workflows.data_pipelines.rne.database.task_functions import (
...
with DAG(
    ...
    clean_previous_outputs = BashOperator(
        ...
        bash_command=f"rm -rf {Settings.RNE_DB_TMP_FOLDER} && mkdir -p {Settings.RNE_DB_TMP_FOLDER}",
    )
    ...
    clean_outputs = BashOperator(
        ...
        bash_command=f"rm -rf {Settings.RNE_DB_TMP_FOLDER}",
    )
